...
export const services = {
  ...
  title: 'שני מסלולים. מטרה אחת: יותר פניות.',
...
export const process = {
  ...
  cta: 'רוצים להתחיל בשלב 1? קבלו הצעה',
} as const;
...
export const portfolio = {
  ...
  placeholder: {
    name: 'פרויקט לדוגמה',
    field: 'יוחלף בפרויקט אמיתי',
    mediaCaption: 'מקום שמור לצילום מסך של הפרויקט',
    badge: 'בקרוב',
  },
...
export const whyUs = {
  eyebrow: 'למה אנחנו',
  title: 'אתר שנבנה סביב העסק שלכם, לא סביב תבנית.',
  items: [
    {
...
export const beforeAfter = {
  ...
  afterLabel: 'אחרי',
  illustration: 'המחשה',
  beforeCaption: 'טקסט צפוף · אין קריאה לפעולה · לא מותאם לטלפון',
...
export const pricingCopy = {
  eyebrow: 'חבילות',
  title: 'בוחרים מסלול. מקבלים הצעה מסודרת.',
  intro:
    'כל פרויקט מתומחר לפי אפיון, כי אין שני עסקים זהים. בוחרים את המסלול שמתאים לכם, ואנחנו חוזרים אליכם עם הצעה ברורה.',
  noPrice: 'הצעת מחיר לפי אפיון',
  noPriceSub: 'הצעת מחיר מדויקת אחרי שיחה קצרה — בלי הפתעות',
  from: 'החל מ-',
  ...
  budgetNote: 'תקציב הפרסום בגוגל אינו כלול בדמי הניהול ומשולם ישירות ל-Google.',
  ownership: 'האתר, הדומיין והתכנים שלכם.',
...
export const faqCopy = {
  ...
  title: 'שאלות נפוצות',
  intro: 'לא מצאתם תשובה? דברו איתנו ב-WhatsApp ונענה בשמחה.',
...
export const form = {
  ...
  errors: {
    required: 'שדה חובה',
    nameShort: 'הזינו שם מלא',
    phoneInvalid: 'הזינו מספר טלפון ישראלי תקין, לדוגמה 050-0000000',
    interest: 'בחרו את האפשרות שמתאימה לכם',
...
export const seo = {
  title: 'בניית אתרים לעסקים וקידום בגוגל',
  description:
