...
export function StickyCta() {
  return (
    <>
      <div
        className="fixed inset-x-0 bottom-0 z-50 border-t border-ink-800 bg-white/95 px-3 pt-2 backdrop-blur-lg sm:hidden"
      ...
      >
        <div className="grid grid-cols-[1.45fr_1fr] gap-2">
          <WaLink
            ...
            className="shine-pulse flex h-11 items-center justify-center gap-2 rounded-full bg-wa-500 text-[15px] font-extrabold text-white"
          >
      ...
      <WaLink
        ...
        className="shine-pulse group fixed bottom-6 left-6 z-50 hidden h-14 items-center gap-3 rounded-full bg-wa-500 pe-4 ps-3.5 text-white shadow-xl shadow-wa-500/40 transition-colors hover:bg-wa-600 sm:flex"
      >
