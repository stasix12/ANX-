...
export const landingPages: LandingPage[] = [
  ...
  },
  {
    ...
    guide: {
      title: 'ניקוי מזרנים בבאר שבע – איך זה עובד',
      blocks: [
        {
          title: 'מה יוצא מהמזרן בניקוי?',
          body: 'זיעה, תאי עור, אבק וקרדית האבק שמצטברים במזרן שנה אחרי שנה – וכתמים של נוזלים שספגו פנימה. שיטת ההזרקה-יניקה מכניסה תמיסת ניקוי לתוך המזרן ושואבת אותה בחזרה עם כל מה שהיה בפנים, ולא רק מנקה את הבד העליון.',
        },
        {
          title: 'מזרן יחיד או זוגי, צד אחד או שניים?',
          body: `מזרן זוגי מתחיל ב-${priceText(279)} לצד אחד. מזרן יחיד, או ניקוי של שני הצדדים, מתומחר לפי תמונה – ציינו את זה בהודעה ונחזור עם מחיר מדויק לפני שמגיעים.`,
        },
        {
          title: 'מתי אפשר לישון עליו?',
          body: 'המזרן יוצא מהניקוי לח ומתייבש ברוב המקרים תוך 3 עד 6 שעות, בעזרת חלון פתוח או מאוורר. ניקוי בבוקר או בצהריים משאיר את המזרן יבש לגמרי עד הלילה.',
        },
        {
          title: 'עבודה שביצענו בבאר שבע',
          body: 'המזרן היחיד בתמונות "לפני ואחרי" למעלה נוקה אצל לקוח בבאר שבע – תמונה אמיתית מהעבודה, לא סטוק.',
        },
      ],
    },
  },
  {
    ...
    guide: {
      ...
      blocks: [
        {
          title: 'מה מנקים ברכב?',
          body: `המושבים הקדמיים והאחוריים בניקוי עמוק בהזרקה-יניקה, החל מ-${priceText(299)}. ריפודי דלתות ושטיחונים אפשר להוסיף – ציינו בהודעה ונתמחר יחד.`,
        },
        {
          title: 'איפה מתבצע הניקוי?',
          body: 'איפה שנוח לכם: ליד הבית, בחניון בעבודה או בכל מקום שאפשר לעמוד בו עם הרכב. מתאמים מראש איפה ומתי, ומגיעים עם הציוד.',
        },
        {
          title: 'קפה, אוכל וריח עשן',
          body: 'רוב הכתמים היומיומיים – קפה, שתייה, אוכל, בוץ – יורדים בניקוי עמוק, וריחות של עשן או אוכל נעלמים יחד איתם כי הלכלוך שיצר אותם נשאב מתוך הריפוד. כתמי דיו או צבע לא תמיד יורדים לגמרי – שלחו תמונה ונגיד בכנות.',
        },
      ],
    },
  },
  {
    ...
    guide: {
      title: 'ניקוי שטיחים בבאר שבע – בבית, בלי לגלגל',
      blocks: [
        {
          title: 'שטיח סלון או מקיר לקיר?',
          body: 'שניהם מנוקים במקום שבו הם מונחים. שטיח מקיר לקיר אי אפשר להוביל בכלל, ושטיח סלון פשוט לא צריך: המכונה מגיעה אליו, מזריקה תמיסה לתוך הסיבים ושואבת אותה בחזרה עם האבק והכתמים.',
        },
        {
          title: 'איך נקבע המחיר?',
          body: 'לפי גודל השטיח וסוג הסיבים – שטיח צמר ושטיח סינתטי מטופלים אחרת. שלחו תמונה עם מידות משוערות (אפשר בצעדים) ונחזור עם מחיר שנסגר מראש.',
        },
        {
          title: 'כמה זמן השטיח מתייבש?',
          body: 'השאיבה מוציאה את רוב הלחות בזמן הניקוי, והשטיח נשאר לח ולא רטוב. ברוב המקרים הוא יבש תוך כמה שעות – מומלץ לא להחזיר עליו רהיטים עד שהוא יבש לגמרי.',
        },
      ],
    },
  },
